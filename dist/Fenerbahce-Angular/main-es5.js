...
var AddEventComponent = /** @class */ (function () {
    function AddEventComponent(eventService, spinnerService, snackBar, dialogRef, data) {
    ...
    AddEventComponent.prototype.ngOnInit = function () {
        ...
        if (this.data.loadGroups) {
            this.data.loadGroups(function (response) {
    ...
    AddEventComponent.prototype.createEvent = function (eventForm) {
        var _this = this;
        var eventTime = eventForm.eventTime;
        var eventDate = eventForm.eventDate;
        ...
        this.eventService.createEvent(event, eventForm.frequency, eventForm.dueDate || new Date()).subscribe(function (res) {
            _this.spinnerService.HideSpinner('LoadingProcess');
            _this.dialogRef.close();
            _this.snackBar.open("Event is added!", "Got it", {
                duration: 2000
            });
        });
    };
    ;
    AddEventComponent.prototype.isDueDateEnable = function () {
        return this.eventForm.value.frequency != 0;
    };
    AddEventComponent.prototype.initFormGroup = function () {
...
var AddGroupComponent = /** @class */ (function () {
    function AddGroupComponent(groupService, sportService, schoolService, spinnerService, snackBar, dialogRef) {
    ...
    AddGroupComponent.prototype.addGroup = function (addGroupForm) {
        var _this = this;
        var group = {
            GroupId: 0,
        ...
        this.spinnerService.ShowSpinner('LoadingProcess');
        this.groupService.createGroup(group).subscribe(function (res) {
            _this.spinnerService.HideSpinner('LoadingProcess');
            _this.dialogRef.close();
            _this.snackBar.open("Group is registered!", "Got it", {
                duration: 2000
            });
        });
    };
    ;
    AddGroupComponent.prototype.hasError = function (controlName, errorName) {
        return this.addGroupForm.controls[controlName].hasError(errorName);
    };
    ;
    AddGroupComponent.prototype.initFormGroup = function () {
    ...
    ;
    AddGroupComponent.prototype.getSports = function () {
        var _this = this;
        this.sportService.getSports().subscribe(function (res) {
            _this.spinnerService.HideSpinner('LoadingProcess');
            _this.sports = res;
        });
    };
    ;
    AddGroupComponent.prototype.getSchools = function () {
        var _this = this;
        this.schoolService.getSchools().subscribe(function (res) {
            _this.spinnerService.HideSpinner('LoadingProcess');
            _this.schools = res;
        });
    };
...
var AddInstructorComponent = /** @class */ (function () {
    function AddInstructorComponent(instructorService, snackBar, dialogRef, spinnerService, data) {
    ...
    AddInstructorComponent.prototype.ngOnInit = function () {
    ...
    AddInstructorComponent.prototype.addInstructor = function (addInstructorForm) {
        var _this = this;
        var groupInstructor = {
        ...
        this.spinnerService.ShowSpinner('LoadingProcess');
        this.instructorService.addInstructor(groupInstructor).subscribe(function (res) {
            _this.spinnerService.HideSpinner('LoadingProcess');
            _this.dialogRef.close();
            _this.snackBar.open("Instructor are registered!", "Got it", {
                duration: 2000
            });
        });
    };
    AddInstructorComponent.prototype.hasError = function (controlName, errorName) {
        return this.addInstructorForm.controls[controlName].hasError(errorName);
    };
    ;
    AddInstructorComponent.prototype.initFormInstructor = function () {
    ...
    ;
    AddInstructorComponent.prototype.getInstructors = function () {
        var _this = this;
        this.spinnerService.ShowSpinner('LoadingProcess');
        this.instructorService.getInstructors().subscribe(function (res) {
            _this.spinnerService.HideSpinner('LoadingProcess');
            _this.instructors = res;
        });
    };
    AddInstructorComponent.ctorParameters = function () { return [
...
var AddNewsComponent = /** @class */ (function () {
    function AddNewsComponent(newsService, spinnerService, router, snackBar) {
    ...
    AddNewsComponent.prototype.create = function (newsForm) {
        var _this = this;
        var news = {
            NewsId: 0,
        ...
        this.spinnerService.ShowSpinner('LoadingProcess');
        this.newsService.createNews(news).subscribe(function (res) {
            if (_this.formData) {
                _this.newsService.addNewsImage(res, _this.formData).subscribe(function (res) {
                    _this.spinnerService.HideSpinner('LoadingProcess');
                    _this.snackBar.open("News added!", "Got it", {
                        duration: 2000
                    });
                });
            }
    ...
    ;
    AddNewsComponent.prototype.initFormGroup = function () {
    ...
    ;
    AddNewsComponent.prototype.onFileChanged = function (event) {
        var newsLogo = event.target.files[0];
...
var AddPaymentComponent = /** @class */ (function () {
    function AddPaymentComponent(paymentService, spinnerService, snackBar, dialogRef, data) {
    ...
    AddPaymentComponent.prototype.addPayment = function (addPaymentForm) {
        var _this = this;
        var payment = {
            PaymentId: 0,
        ...
        this.spinnerService.ShowSpinner('LoadingProcess');
        this.paymentService.createPayment(payment).subscribe(function (res) {
            _this.spinnerService.HideSpinner('LoadingProcess');
            _this.dialogRef.close();
            _this.snackBar.open("Payment is added!", "Got it", {
                duration: 2000
            });
        });
    };
    ;
    AddPaymentComponent.prototype.initFormGroup = function () {
...
var AddSchoolComponent = /** @class */ (function () {
    function AddSchoolComponent(schoolService, spinnerService, snackBar, dialogRef) {
        this.schoolService = schoolService;
        this.spinnerService = spinnerService;
        this.snackBar = snackBar;
        this.dialogRef = dialogRef;
    ...
    AddSchoolComponent.prototype.create = function (schoolFormValues) {
        var _this = this;
        this.spinnerService.ShowSpinner('LoadingProcess');
        this.schoolService.createSchool(schoolFormValues.schoolName, this.formData).subscribe(function (res) {
            _this.spinnerService.HideSpinner('LoadingProcess');
            _this.dialogRef.close();
            _this.snackBar.open("School created!", "Got it", {
                duration: 2000
            });
        });
    };
    ;
    AddSchoolComponent.prototype.initFormGroup = function () {
    ...
    ;
    AddSchoolComponent.prototype.onFileChanged = function (event) {
...
var AddStudentComponent = /** @class */ (function () {
    function AddStudentComponent(studentService, spinnerService, snackBar, dialogRef, data) {
    ...
    AddStudentComponent.prototype.addStudent = function (addStudentForm) {
        var _this = this;
        var student = {
        ...
        this.spinnerService.ShowSpinner('LoadingProcess');
        this.studentService.createStudent(student, this.data.GroupId).subscribe(function (res) {
            _this.spinnerService.HideSpinner('LoadingProcess');
            _this.dialogRef.close();
            _this.snackBar.open("Student are registered!", "Got it", {
                duration: 2000
            });
        });
    };
    AddStudentComponent.prototype.hasError = function (controlName, errorName) {
        return this.addStudentForm.controls[controlName].hasError(errorName);
    };
    ;
    AddStudentComponent.prototype.initFormStudent = function () {
...
/* harmony import */ var _fullcalendar_angular__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(/*! @fullcalendar/angular */ "./node_modules/@fullcalendar/angular/fesm5/fullcalendar-angular.js");
...
var Constants = /** @class */ (function () {
    ...
    Constants.AuthorizationServiceConstants = (_a = /** @class */ (function () {
            function class_1() {
            }
            return class_1;
        }()),
    ...
    Constants.DataValidationConstants = (_b = /** @class */ (function () {
            function class_2() {
            }
            return class_2;
        }()),
        ...
        _b);
    Constants.InstuctorConstants = (_c = /** @class */ (function () {
            function class_3() {
            }
            return class_3;
        }()),
        ...
        _c);
    Constants.PaymentConstants = (_d = /** @class */ (function () {
            function class_4() {
            }
            return class_4;
        }()),
        ...
        _d);
    Constants.EventConstants = (_e = /** @class */ (function () {
            function class_5() {
            }
            return class_5;
        }()),
        ...
        _e);
    Constants.RegistrationConstants = (_f = /** @class */ (function () {
            function class_6() {
            }
            return class_6;
        }()),
...
var EditEventComponent = /** @class */ (function () {
    function EditEventComponent(eventService, spinnerService, snackBar, dialogRef, data) {
        this.eventService = eventService;
        this.spinnerService = spinnerService;
        this.snackBar = snackBar;
        this.dialogRef = dialogRef;
    ...
    EditEventComponent.prototype.createEvent = function (eventForm) {
        var _this = this;
        var eventTime = eventForm.eventTime;
        var eventDate = eventForm.eventDate;
        eventDate.setHours(parseInt(eventTime.substr(0, 2)), parseInt(eventTime.substr(3, 2)));
        ...
        this.spinnerService.ShowSpinner('LoadingProcess');
        this.eventService.updateEvent(event).subscribe(function (res) {
            _this.spinnerService.HideSpinner('LoadingProcess');
            _this.dialogRef.close();
            _this.snackBar.open("Event is edited!", "Got it", {
                duration: 2000
            });
        });
    };
    ;
    EditEventComponent.prototype.initFormGroup = function () {
        var eventTime = this.data.Event.EventTime.substr(11, 5);
...
var EditGroupComponent = /** @class */ (function () {
    function EditGroupComponent(groupService, sportService, schoolService, spinnerService, snackBar, dialogRef, data) {
        this.groupService = groupService;
        this.sportService = sportService;
        this.schoolService = schoolService;
        this.spinnerService = spinnerService;
    ...
    EditGroupComponent.prototype.saveGroup = function (editGroupForm) {
        var _this = this;
        var group = {
        ...
        this.spinnerService.ShowSpinner('LoadingProcess');
        this.groupService.updateGroup(group).subscribe(function (res) {
            _this.spinnerService.HideSpinner('LoadingProcess');
            _this.dialogRef.close();
            _this.snackBar.open("Group is updated!", "Got it", {
                duration: 2000
            });
        });
    };
    ;
    EditGroupComponent.prototype.hasError = function (controlName, errorName) {
        return this.editGroupForm.controls[controlName].hasError(errorName);
    };
    ;
    EditGroupComponent.prototype.initFormGroup = function () {
    ...
    ;
    EditGroupComponent.prototype.getSports = function () {
        var _this = this;
        this.spinnerService.ShowSpinner('LoadingProcess');
        this.sportService.getSports().subscribe(function (res) {
            _this.spinnerService.HideSpinner('LoadingProcess');
    ...
    ;
    EditGroupComponent.prototype.getSchools = function () {
        var _this = this;
        this.spinnerService.ShowSpinner('LoadingProcess');
        this.schoolService.getSchools().subscribe(function (res) {
            _this.spinnerService.HideSpinner('LoadingProcess');
    ...
    ;
    EditGroupComponent.ctorParameters = function () { return [
        { type: _services_group_service__WEBPACK_IMPORTED_MODULE_3__["GroupService"] },
        { type: _services_sport_service__WEBPACK_IMPORTED_MODULE_4__["SportService"] },
        { type: _services_school_service__WEBPACK_IMPORTED_MODULE_5__["SchoolService"] },
        { type: _services_spinner_service__WEBPACK_IMPORTED_MODULE_7__["SpinnerService"] },
...
var EditInstructorComponent = /** @class */ (function () {
    function EditInstructorComponent(instructorService, snackBar, dialogRef, data) {
        this.instructorService = instructorService;
        this.snackBar = snackBar;
        this.dialogRef = dialogRef;
        this.data = data;
    }
    EditInstructorComponent.prototype.ngOnInit = function () {
        this.initFormInstructor();
        this.salaryTypes = _constants__WEBPACK_IMPORTED_MODULE_5__["Constants"].InstuctorConstants.SalaryTypes;
        this.getInstructors();
        //this.createCallback = new EventEmitter();
    };
    EditInstructorComponent.prototype.editInstructor = function (editInstructorForm) {
        var _this = this;
        var groupInstructor = {
        ...
        this.instructorService.updateInstructor(groupInstructor).subscribe(function (res) {
            _this.dialogRef.close();
            _this.snackBar.open("Instructor are update!", "Got it", {
                duration: 2000
            });
        });
    };
    EditInstructorComponent.prototype.hasError = function (controlName, errorName) {
        return this.editInstructorForm.controls[controlName].hasError(errorName);
    };
    ;
    EditInstructorComponent.prototype.initFormInstructor = function () {
    ...
    ;
    EditInstructorComponent.prototype.getInstructors = function () {
        var _this = this;
        this.instructorService.getInstructors().subscribe(function (res) {
            _this.instructors = res;
        });
    };
    EditInstructorComponent.ctorParameters = function () { return [
    ...
    return EditInstructorComponent;
}());
...
var EditNewsComponent = /** @class */ (function () {
    function EditNewsComponent(newsService, spinnerService, snackBar, dialogRef, data) {
        this.newsService = newsService;
        this.spinnerService = spinnerService;
        this.snackBar = snackBar;
        this.dialogRef = dialogRef;
    ...
    EditNewsComponent.prototype.create = function (newsForm) {
        var _this = this;
        var news = {
        ...
        this.spinnerService.ShowSpinner('LoadingProcess');
        this.newsService.updateNews(news).subscribe(function (res) {
            if (_this.formData) {
                _this.newsService.addNewsImage(news.NewsId, _this.formData).subscribe(function (res) {
                    _this.spinnerService.HideSpinner('LoadingProcess');
                    _this.snackBar.open("News updated!", "Got it", {
                        duration: 2000
                    });
                });
            }
    ...
    ;
    EditNewsComponent.prototype.initFormGroup = function () {
        this.newsForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
...
var EditPaymentComponent = /** @class */ (function () {
    function EditPaymentComponent(paymentService, spinnerService, snackBar, dialogRef, data) {
        this.paymentService = paymentService;
        this.spinnerService = spinnerService;
        this.snackBar = snackBar;
        this.dialogRef = dialogRef;
    ...
    EditPaymentComponent.prototype.updatePayment = function (addPaymentForm) {
        var _this = this;
        var payment = {
        ...
        this.spinnerService.ShowSpinner('LoadingProcess');
        this.paymentService.updatePayment(payment).subscribe(function (res) {
            _this.spinnerService.HideSpinner('LoadingProcess');
            _this.dialogRef.close();
            _this.snackBar.open("Payment is edited!", "Got it", {
                duration: 2000
            });
        });
    };
    ;
    EditPaymentComponent.prototype.initFormGroup = function () {
...
var EditSchoolComponent = /** @class */ (function () {
    function EditSchoolComponent(schoolService, spinnerService, snackBar, dialogRef, data) {
        this.schoolService = schoolService;
        this.spinnerService = spinnerService;
        this.snackBar = snackBar;
        this.dialogRef = dialogRef;
    ...
    EditSchoolComponent.prototype.create = function (schoolFormValues) {
        var _this = this;
        this.spinnerService.ShowSpinner('LoadingProcess');
        this.schoolService.updateSchool(schoolFormValues.schoolName, this.school.SchoolId, this.formData).subscribe(function (res) {
            _this.spinnerService.HideSpinner('LoadingProcess');
            _this.dialogRef.close();
            _this.snackBar.open("School created!", "Got it", {
                duration: 2000
    ...
    ;
    EditSchoolComponent.prototype.initFormGroup = function () {
        this.schoolForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
    ...
    ;
    EditSchoolComponent.prototype.onFileChanged = function (event) {
        var logo = event.target.files[0];
        this.formData = new FormData();
        this.formData.append('image', logo, logo.name);
    };
...
var EditStudentComponent = /** @class */ (function () {
    function EditStudentComponent(studentService, snackBar, dialogRef, data) {
        this.studentService = studentService;
        this.snackBar = snackBar;
        this.dialogRef = dialogRef;
        this.data = data;
    ...
    EditStudentComponent.prototype.editStudent = function (editStudentForm) {
        var _this = this;
        var student = {
        ...
        this.studentService.updateStudent(student, this.data.GroupId).subscribe(function (res) {
            _this.dialogRef.close();
            _this.snackBar.open("Student are update!", "Got it", {
                duration: 2000
            });
        });
    };
    EditStudentComponent.prototype.hasError = function (controlName, errorName) {
        return this.editStudentForm.controls[controlName].hasError(errorName);
    };
    ;
    EditStudentComponent.prototype.initFormStudent = function () {
...
var GroupScheduleComponent = /** @class */ (function () {
    function GroupScheduleComponent(groupService, spinnerService, eventService, route, router, dialog, datepipe) {
        this.groupService = groupService;
        this.spinnerService = spinnerService;
        this.eventService = eventService;
        this.route = route;
    ...
    GroupScheduleComponent.prototype.ngOnInit = function () {
    };
    GroupScheduleComponent.prototype.handleDateChange = function () {
        this.loadData();
    };
    GroupScheduleComponent.prototype.handleEventClick = function (info) {
        var _this = this;
        var eventId = info.event._def.extendedProps.EventId;
        this.eventService.getEventById(eventId).subscribe(function (response) {
            _this.updateEvent(response);
        });
    };
    GroupScheduleComponent.prototype.eventDrop = function (info) {
        var _this = this;
        var newDate = info.event.start.toISOString(), eventId = info.event._def.extendedProps.EventId;
        this.spinnerService.ShowSpinner('LoadingProcess');
        this.eventService.updateEventDate(eventId, newDate).subscribe(function (response) {
            _this.spinnerService.HideSpinner('LoadingProcess');
        });
    };
    GroupScheduleComponent.prototype.createEvent = function () {
        var _this = this;
        var groupId = Number.parseInt(this.route.snapshot.paramMap.get('id'));
    ...
    GroupScheduleComponent.prototype.updateEvent = function (event) {
        var _this = this;
        var dialogRef = this.dialog.open(_edit_event_edit_event_component__WEBPACK_IMPORTED_MODULE_11__["EditEventComponent"], {
            width: '540px',
            height: 'auto',
            data: {
                Event: event
    ...
    GroupScheduleComponent.prototype.loadData = function () {
        var _this = this;
        var groupId = Number.parseInt(this.route.snapshot.paramMap.get('id'));
        this.spinnerService.ShowSpinner('LoadingProcess');
        var month = this.calendarComponent.getApi().getDate().getMonth() + 1;
        var year = this.calendarComponent.getApi().getDate().getFullYear();
        this.eventService.getGroupEvents(groupId, month, year).subscribe(function (response) {
            _this.events = response.map(function (x) { return _this.mapResponse(x); });
            _this.spinnerService.HideSpinner('LoadingProcess');
        });
    };
    GroupScheduleComponent.prototype.mapResponse = function (calendarEvent) {
        return {
    ...
    GroupScheduleComponent.ctorParameters = function () { return [
...
var GroupComponent = /** @class */ (function () {
    function GroupComponent(route, groupService, authService, instructorService, router, spinnerService, dialog) {
        this.route = route;
        this.groupService = groupService;
    ...
    GroupComponent.prototype.IsAdmin = function () {
        return this.authService.isAdmin();
    };
    GroupComponent.prototype.getSalaryDescription = function (salaryCode) {
        var salaryDefModel = this.salaryTypes.find(function (x) { return x.TypeCode == salaryCode; });
        return salaryDefModel ? salaryDefModel.TypeDescription : '';
    };
    GroupComponent.prototype.ModalStudent = function () {
        var _this = this;
        var dialogRef = this.dialog.open(_add_student_add_student_component__WEBPACK_IMPORTED_MODULE_5__["AddStudentComponent"], {
            width: '540px',
            height: '450px',
            data: {
                GroupId: this.group.GroupId
    ...
    GroupComponent.prototype.deleteGroup = function () {
        var _this = this;
        this.groupService.deleteGroup(this.group.GroupId).subscribe(function (response) {
            _this.router.navigate(['/groups']);
        });
    };
    ;
    GroupComponent.prototype.openSchedule = function () {
        this.router.navigate(['./schedule'], { relativeTo: this.route });
    };
    GroupComponent.prototype.deleteInstructor = function (instructorId, groupId) {
        var _this = this;
        this.instructorService.deleteInstructor(instructorId, groupId).subscribe(function (response) {
            _this.loadData();
        });
    };
    ;
    GroupComponent.prototype.ModalInstructor = function () {
        var _this = this;
        var dialogRef = this.dialog.open(_add_instructor_add_instructor_component__WEBPACK_IMPORTED_MODULE_6__["AddInstructorComponent"], {
            width: '540px',
            height: '450px',
            data: {
                GroupId: this.group.GroupId
    ...
    GroupComponent.prototype.editInstructor = function (groupInstructor) {
        var _this = this;
        var dialogRef = this.dialog.open(_edit_instructor_edit_instructor_component__WEBPACK_IMPORTED_MODULE_10__["EditInstructorComponent"], {
            width: '540px',
            height: '450px',
            data: {
    ...
    GroupComponent.prototype.editGroup = function () {
        var _this = this;
        var dialogRef = this.dialog.open(_edit_group_edit_group_component__WEBPACK_IMPORTED_MODULE_7__["EditGroupComponent"], {
            width: '540px',
            height: '370px',
            data: {
                Group: this.group
    ...
    GroupComponent.prototype.loadData = function () {
        var _this = this;
        this.spinnerService.ShowSpinner('LoadingProcess');
        var groupId = Number.parseInt(this.route.snapshot.paramMap.get('id'));
...
var GroupsComponent = /** @class */ (function () {
    function GroupsComponent(groupService, authService, dialog, spinnerService) {
        this.groupService = groupService;
        this.authService = authService;
        this.dialog = dialog;
        this.spinnerService = spinnerService;
    ...
    GroupsComponent.prototype.IsAdmin = function () {
        return this.authService.isAdmin();
    };
    GroupsComponent.prototype.openDialog = function () {
        var _this = this;
        var dialogRef = this.dialog.open(_add_group_add_group_component__WEBPACK_IMPORTED_MODULE_4__["AddGroupComponent"], {
            width: '540px',
            height: '380px'
        });
        dialogRef.afterClosed().subscribe(function (res) {
    ...
    GroupsComponent.prototype.loadData = function () {
        var _this = this;
        this.spinnerService.ShowSpinner('LoadingProcess');
        this.groupService.getGroups().subscribe(function (response) {
            _this.groups = response;
            _this.spinnerService.HideSpinner('LoadingProcess');
        });
    };
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(authService, spinnerService, globalService, snackBar) {
        this.authService = authService;
        this.spinnerService = spinnerService;
    ...
    LoginComponent.prototype.login = function (loginFormValues) {
        ...
        this.authService.login(user).subscribe(function (res) {
            _this.spinnerService.HideSpinner('LoadingProcess');
            _this.globalService.setToken(res);
            _this.loginEvent.emit(null);
            _this.snackBar.open("You are log in!", "Got it", {
                duration: 2000
            });
        });
    };
    ;
    LoginComponent.prototype.initFormGroup = function () {
...
var MainComponent = /** @class */ (function () {
    ...
    MainComponent.prototype.ngOnInit = function () {
        ...
        this.globalService.storageItem.subscribe(function (res) {
            _this.isUserLogin = _this.globalService.isLoginUser();
        });
    };
    MainComponent.prototype.loginCallback = function () {
...
var NewsDetailComponent = /** @class */ (function () {
    function NewsDetailComponent(newsService, authService, spinnerService, route, router, dialog) {
        this.newsService = newsService;
        this.authService = authService;
        this.spinnerService = spinnerService;
        this.route = route;
    ...
    NewsDetailComponent.prototype.loadData = function () {
        var _this = this;
        this.spinnerService.ShowSpinner('LoadingProcess');
        var newsId = Number.parseInt(this.route.snapshot.paramMap.get('id'));
        this.newsService.getNewsById(newsId).subscribe(function (response) {
            _this.news = response;
            _this.spinnerService.HideSpinner('LoadingProcess');
        });
        this.newsService.getNewsImageById(newsId).subscribe(function (response) {
            _this.createImageFromBlob(response);
            _this.spinnerService.HideSpinner('LoadingProcess');
        });
    };
    NewsDetailComponent.prototype.editNews = function () {
        var _this = this;
        var dialogRef = this.dialog.open(_edit_news_edit_news_component__WEBPACK_IMPORTED_MODULE_7__["EditNewsComponent"], {
            width: '1080px',
            height: '540px',
            data: {
                News: this.news,
    ...
    NewsDetailComponent.prototype.deleteNews = function () {
        var _this = this;
        this.spinnerService.ShowSpinner('LoadingProcess');
        this.newsService.deleteNews(this.news.NewsId).subscribe(function (response) {
            _this.spinnerService.HideSpinner('LoadingProcess');
            _this.router.navigate(['']);
        });
    };
    ;
    NewsDetailComponent.prototype.IsAdmin = function () {
        return this.authService.isAdmin();
    };
    NewsDetailComponent.prototype.createImageFromBlob = function (image) {
        var _this = this;
        var reader = new FileReader();
        reader.addEventListener("load", function () {
            _this.newsImage = reader.result;
        });
        if (image && image.size > 0) {
            reader.readAsDataURL(image);
        }
    };
    NewsDetailComponent.ctorParameters = function () { return [
        { type: _services_news_service__WEBPACK_IMPORTED_MODULE_6__["NewsService"] },
...
var NewsComponent = /** @class */ (function () {
    function NewsComponent(newsService, authService, spinnerService, dialog) {
        this.newsService = newsService;
        this.authService = authService;
        this.spinnerService = spinnerService;
        this.dialog = dialog;
    ...
    NewsComponent.prototype.IsAdmin = function () {
        return this.authService.isAdmin();
    };
    NewsComponent.prototype.loadData = function () {
        var _this = this;
        this.spinnerService.ShowSpinner('LoadingProcess');
        this.newsService.getNews().subscribe(function (response) {
            _this.news = response;
            _this.spinnerService.HideSpinner('LoadingProcess');
        });
    };
...
var RegisterUserComponent = /** @class */ (function () {
    function RegisterUserComponent(authService, spinnerService, snackBar, dialogRef) {
        this.authService = authService;
        this.spinnerService = spinnerService;
        this.snackBar = snackBar;
        this.dialogRef = dialogRef;
    ...
    ;
    RegisterUserComponent.prototype.register = function (registerFormValues) {
        var _this = this;
        var user = {
        ...
        this.authService.registerUser(user).subscribe(function (res) {
            _this.spinnerService.HideSpinner('LoadingProcess');
            _this.dialogRef.close();
            _this.snackBar.open("User is registered!", "Got it", {
                duration: 2000
            });
        });
    };
    ;
    RegisterUserComponent.prototype.hasError = function (controlName, errorName) {
        return this.registerForm.controls[controlName].hasError(errorName);
    };
    ;
    RegisterUserComponent.prototype.pinKeyPress = function (event) {
        var pattern = /[0-9]/;
    ...
    ;
    RegisterUserComponent.prototype.passwordMatchValidator = function (formGroup) {
        return formGroup.get('password').value === formGroup.get('confirmPassword').value &&
            formGroup.get('pin').value === formGroup.get('confirmPin').value
            ? null : { 'mismatch': true };
    };
    ;
    RegisterUserComponent.prototype.initFormGroup = function () {
...
var SchoolScheduleComponent = /** @class */ (function () {
    function SchoolScheduleComponent(groupService, spinnerService, eventService, route, router, dialog, datepipe) {
        this.groupService = groupService;
        this.spinnerService = spinnerService;
        this.eventService = eventService;
        this.route = route;
    ...
    SchoolScheduleComponent.prototype.ngOnInit = function () {
    };
    SchoolScheduleComponent.prototype.handleDateChange = function () {
        this.loadData();
    };
    SchoolScheduleComponent.prototype.handleEventClick = function (info) {
        var _this = this;
        var eventId = info.event._def.extendedProps.EventId;
        this.eventService.getEventById(eventId).subscribe(function (response) {
            _this.updateEvent(response);
    ...
    SchoolScheduleComponent.prototype.eventDrop = function (info) {
        var _this = this;
        var newDate = info.event.start.toISOString(), eventId = info.event._def.extendedProps.EventId;
        this.spinnerService.ShowSpinner('LoadingProcess');
        this.eventService.updateEventDate(eventId, newDate).subscribe(function (response) {
    ...
    SchoolScheduleComponent.prototype.createEvent = function () {
        var _this = this;
        var schoolId = Number.parseInt(this.route.snapshot.paramMap.get('id'));
        this.spinnerService.ShowSpinner('LoadingProcess');
        var dialogRef = this.dialog.open(_add_event_add_event_component__WEBPACK_IMPORTED_MODULE_6__["AddEventComponent"], {
            width: '540px',
            height: 'auto',
            data: {
                GroupId: 0,
                loadGroups: (function (loadCallBack) {
                    _this.groupService.getSchoolGroups(schoolId).subscribe(function (response) {
                        _this.spinnerService.HideSpinner('LoadingProcess');
    ...
    SchoolScheduleComponent.prototype.updateEvent = function (event) {
        var _this = this;
        var dialogRef = this.dialog.open(_edit_event_edit_event_component__WEBPACK_IMPORTED_MODULE_11__["EditEventComponent"], {
            width: '540px',
            height: 'auto',
    ...
    SchoolScheduleComponent.prototype.loadData = function () {
        var _this = this;
        var schoolId = Number.parseInt(this.route.snapshot.paramMap.get('id'));
        this.spinnerService.ShowSpinner('LoadingProcess');
        var month = this.calendarComponent.getApi().getDate().getMonth() + 1;
        var year = this.calendarComponent.getApi().getDate().getFullYear();
        this.eventService.getSchoolEvents(schoolId, month, year).subscribe(function (response) {
            _this.events = response.map(function (x) { return _this.mapResponse(x); });
            _this.spinnerService.HideSpinner('LoadingProcess');
        });
    };
    SchoolScheduleComponent.prototype.mapResponse = function (calendarEvent) {
        return {
            EventId: calendarEvent.EventId,
            title: calendarEvent.GroupName + ' \n' +
                new Date(calendarEvent.EventDate).toTimeString().substring(0, 9) + '\nDuration: ' +
    ...
    SchoolScheduleComponent.ctorParameters = function () { return [
        { type: _services_group_service__WEBPACK_IMPORTED_MODULE_7__["GroupService"] },
        { type: _services_spinner_service__WEBPACK_IMPORTED_MODULE_8__["SpinnerService"] },
        { type: _services_event_service__WEBPACK_IMPORTED_MODULE_9__["EventService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] },
    ...
    return SchoolScheduleComponent;
}());
...
var SchoolComponent = /** @class */ (function () {
    function SchoolComponent(schoolService, authService, spinnerService, route, router, dialog) {
        this.schoolService = schoolService;
        this.authService = authService;
        this.spinnerService = spinnerService;
        this.route = route;
    ...
    SchoolComponent.prototype.editSchool = function () {
        var _this = this;
        var dialogRef = this.dialog.open(_edit_school_edit_school_component__WEBPACK_IMPORTED_MODULE_6__["EditSchoolComponent"], {
            width: '540px',
            height: '270px',
            data: {
                School: this.school,
    ...
    SchoolComponent.prototype.deleteSchool = function () {
        var _this = this;
        this.spinnerService.ShowSpinner('LoadingProcess');
        this.schoolService.deleteSchool(this.school.SchoolId).subscribe(function (response) {
            _this.spinnerService.HideSpinner('LoadingProcess');
            _this.router.navigate(['/schools']);
        });
    };
    ;
    SchoolComponent.prototype.openSchedule = function () {
        this.router.navigate(['./schedule'], { relativeTo: this.route });
    };
    SchoolComponent.prototype.loadData = function () {
        var _this = this;
        this.spinnerService.ShowSpinner('LoadingProcess');
        var schoolId = Number.parseInt(this.route.snapshot.paramMap.get('id'));
        this.schoolService.getSchoolById(schoolId).subscribe(function (response) {
            _this.school = response;
            _this.spinnerService.HideSpinner('LoadingProcess');
        });
        this.schoolService.getSchoolLogoById(schoolId).subscribe(function (response) {
            _this.createImageFromBlob(response);
            _this.spinnerService.HideSpinner('LoadingProcess');
        });
    };
    SchoolComponent.prototype.IsAdmin = function () {
        return this.authService.isAdmin();
    };
    SchoolComponent.prototype.createImageFromBlob = function (image) {
        var _this = this;
        var reader = new FileReader();
        reader.addEventListener("load", function () {
            _this.schoolLogo = reader.result;
        });
        if (image && image.size > 0) {
            reader.readAsDataURL(image);
        }
...
var SchoolsComponent = /** @class */ (function () {
    function SchoolsComponent(schoolService, authService, spinnerService, dialog) {
        this.schoolService = schoolService;
        this.authService = authService;
        this.spinnerService = spinnerService;
        this.dialog = dialog;
    ...
    SchoolsComponent.prototype.IsAdmin = function () {
        return this.authService.isAdmin();
    };
    SchoolsComponent.prototype.openDialog = function () {
        var _this = this;
        var dialogRef = this.dialog.open(_add_school_add_school_component__WEBPACK_IMPORTED_MODULE_4__["AddSchoolComponent"], {
            width: '540px',
            height: '310px'
        });
        dialogRef.afterClosed().subscribe(function (res) {
    ...
    SchoolsComponent.prototype.loadData = function () {
        var _this = this;
        this.spinnerService.ShowSpinner('LoadingProcess');
        this.schoolService.getSchools().subscribe(function (response) {
            _this.schools = response;
            _this.spinnerService.HideSpinner('LoadingProcess');
        });
    };
    SchoolsComponent.ctorParameters = function () { return [
        { type: _services_school_service__WEBPACK_IMPORTED_MODULE_2__["SchoolService"] },
        { type: _services_authorization_service__WEBPACK_IMPORTED_MODULE_5__["AuthorizationService"] },
        { type: _services_spinner_service__WEBPACK_IMPORTED_MODULE_6__["SpinnerService"] },
        { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_3__["MatDialog"] }
...
var SearchDialogComponent = /** @class */ (function () {
    function SearchDialogComponent(searchService, spinnerService, data, snackBar, dialogRef) {
    ...
    SearchDialogComponent.prototype.ngOnInit = function () {
        ...
        this.searchInput.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(500))
            ...
            var inputLine = input.toString();
            if (inputLine != null && inputLine != "") {
                _this.searchResult.length = 0;
                _this.searchService.searchParent(inputLine).subscribe(function (res) {
    ...
    SearchDialogComponent.prototype.addParent = function (parentId) {
        var _this = this;
        var data = {
            ParentId: parentId,
            StudentId: this.data.StudentId
        ...
        this.spinnerService.ShowSpinner('LoadingProcess');
        this.searchService.addParent(data).subscribe(function (res) {
            _this.spinnerService.HideSpinner('LoadingProcess');
            _this.dialogRef.close();
            _this.snackBar.open("Parent added!", "Got it", {
                duration: 2000
            });
        });
    };
...
var AuthorizationService = /** @class */ (function () {
    function AuthorizationService(_http, snackBar) {
        this._http = _http;
        this.snackBar = snackBar;
    ...
    AuthorizationService.prototype.registerUser = function (user) {
        var _this = this;
        var tokenData = 'Bearer ' + this.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Content-Type', 'application/json').
            set('Authorization', tokenData), content = user;
        return this._http.post(this.urlForRegisterUser, content, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
    ...
    AuthorizationService.prototype.login = function (user) {
        ...
        return this._http.post(this.urlForLogin, content, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
...
var EventService = /** @class */ (function () {
    function EventService(_http, authService, snackBar) {
        this._http = _http;
        this.authService = authService;
        this.snackBar = snackBar;
    ...
    EventService.prototype.getSchoolEvents = function (schoolId, monthId, year) {
        var _this = this;
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Content-Type', 'application/json').
        ...
        return this._http.get(this.urlForGetSchoolEvents, { headers: headers, params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    EventService.prototype.getGroupEvents = function (groupId, monthId, year) {
        var _this = this;
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Content-Type', 'application/json').
            set('Authorization', tokenData), params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().
            ...
            set('monthId', monthId.toString()).
            set('year', year.toString());
        return this._http.get(this.urlForGetGroupEvents, { headers: headers, params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    EventService.prototype.getEventById = function (eventId) {
        ...
        return this._http.get(this.urlForGetEvent, { headers: headers, params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    EventService.prototype.createEvent = function (event, frequency, dueDate) {
        var _this = this;
        ...
        return this._http.post(this.urlForCreateEvent, content, { headers: headers, params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    EventService.prototype.updateEvent = function (event) {
        ...
        return this._http.put(this.urlForUpdateEvent, content, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    EventService.prototype.updateEventDate = function (eventId, eventDate) {
        var _this = this;
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Content-Type', 'application/json').
            set('Authorization', tokenData), params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().
        ...
        return this._http.put(this.urlForUpdateEventDate, null, { headers: headers, params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    EventService.prototype.deleteEvent = function (eventId) {
        ...
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            ...
            set('Authorization', tokenData), params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().
            set('eventId', eventId.toString());
        return this._http.delete(this.urlForDeleteEvent, { headers: headers, params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
...
var GlobalService = /** @class */ (function () {
    ...
    GlobalService.prototype.setToken = function (tokenData) {
        localStorage.setItem("user", btoa(JSON.stringify(tokenData)));
        this.storageItem.next(tokenData);
    };
    GlobalService.prototype.removeToken = function () {
        localStorage.removeItem("user");
        this.storageItem.next(null);
    };
    GlobalService.prototype.isLoginUser = function () {
...
var GroupService = /** @class */ (function () {
    function GroupService(_http, authService, snackBar) {
        this._http = _http;
        this.authService = authService;
        this.snackBar = snackBar;
    ...
    GroupService.prototype.getGroups = function () {
        ...
        return this._http.get(this.urlForGetGroups, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    GroupService.prototype.getSchoolGroups = function (schoolId) {
        var _this = this;
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Content-Type', 'application/json').
            set('Authorization', tokenData), params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().
            set('schoolId', schoolId.toString());
        return this._http.get(this.urlForGetSchoolGroups, { headers: headers, params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    GroupService.prototype.getGroupById = function (groupId) {
        ...
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            ...
            set('Authorization', tokenData), params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().
            set('groupId', groupId.toString());
        return this._http.get(this.urlForGetGroup, { headers: headers, params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    GroupService.prototype.createGroup = function (group) {
        ...
        return this._http.post(this.urlForCreateGroup, content, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    GroupService.prototype.updateGroup = function (group) {
        ...
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Content-Type', 'application/json').
            set('Authorization', tokenData), content = group;
        return this._http.put(this.urlForUpdateGroup, content, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    GroupService.prototype.deleteGroup = function (groupId) {
        ...
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            ...
            set('Authorization', tokenData), params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().
            set('groupId', groupId.toString());
        return this._http.delete(this.urlForDeleteGroup, { headers: headers, params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
...
var InstructorService = /** @class */ (function () {
    function InstructorService(_http, authService, snackBar) {
        this._http = _http;
        this.authService = authService;
        this.snackBar = snackBar;
    ...
    InstructorService.prototype.getInstructors = function () {
        ...
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Content-Type', 'application/json').
            set('Authorization', tokenData);
        return this._http.get(this.urlForGetInstructors, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    InstructorService.prototype.addInstructor = function (groupInstructor) {
        var _this = this;
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Content-Type', 'application/json').
            set('Authorization', tokenData), content = groupInstructor;
        return this._http.post(this.urlForAddInstructor, content, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    InstructorService.prototype.updateInstructor = function (groupInstructor) {
        var _this = this;
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Content-Type', 'application/json').
            set('Authorization', tokenData), content = groupInstructor;
        return this._http.put(this.urlForUpdateInstructor, content, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    InstructorService.prototype.deleteInstructor = function (instructorId, groupId) {
        var _this = this;
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Content-Type', 'application/json').
            set('Authorization', tokenData), params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().
            ...
            set('groupId', groupId.toString());
        return this._http.delete(this.urlForDeleteInstructor, { headers: headers, params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    ;
    InstructorService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"] },
        { type: _authorization_service__WEBPACK_IMPORTED_MODULE_5__["AuthorizationService"] },
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_6__["MatSnackBar"] }
    ]; };
...
var NewsService = /** @class */ (function () {
    function NewsService(_http, authService, snackBar) {
        this._http = _http;
        this.authService = authService;
        this.snackBar = snackBar;
    ...
    NewsService.prototype.getNews = function () {
        ...
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Content-Type', 'application/json').
            set('Authorization', tokenData);
        return this._http.get(this.urlForGetNews, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    NewsService.prototype.getNewsById = function (newsId) {
        ...
        return this._http.get(this.urlForGetNewsDetail, { headers: headers, params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    NewsService.prototype.getNewsImageById = function (newsId) {
        var _this = this;
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Authorization', tokenData), params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().
            set('newsId', newsId.toString());
        return this._http.get(this.urlForGetNewsImage, { headers: headers, params: params, responseType: 'blob' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    NewsService.prototype.createNews = function (news) {
        ...
        return this._http.post(this.urlForCreateNews, content, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    NewsService.prototype.addNewsImage = function (newsId, image) {
        var _this = this;
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Authorization', tokenData), content = image, params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().
            set('newsId', newsId.toString());
        return this._http.put(this.urlForAddNewsImage, content, { headers: headers, params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    NewsService.prototype.updateNews = function (news) {
        ...
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Content-Type', 'application/json').
            set('Authorization', tokenData), content = news;
        return this._http.put(this.urlForUpdateNews, content, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    NewsService.prototype.deleteNews = function (newsId) {
        ...
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            ...
            set('Authorization', tokenData), params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().
            set('newsId', newsId.toString());
        return this._http.delete(this.urlForDeleteNews, { headers: headers, params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
...
var ParentService = /** @class */ (function () {
    ...
    ParentService.prototype.deleteParent = function (parentId, studentId) {
        ...
        return this._http.delete(this.urlForDeleteParent, { headers: headers, params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    ParentService.prototype.handleError = function (error) {
        if (error.error instanceof ErrorEvent) {
            // A client-side or network error occurred. Handle it accordingly.
            console.error('An error occurred:', error.error.message);
        }
    ...
    ;
    ParentService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"] },
        { type: _authorization_service__WEBPACK_IMPORTED_MODULE_5__["AuthorizationService"] },
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_6__["MatSnackBar"] }
    ]; };
...
var PaymentService = /** @class */ (function () {
    function PaymentService(_http, authService, snackBar) {
        this._http = _http;
        this.authService = authService;
        this.snackBar = snackBar;
    ...
    PaymentService.prototype.createPayment = function (payment) {
        ...
        return this._http.post(this.urlForCreatePayment, content, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    PaymentService.prototype.updatePayment = function (payment) {
        ...
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Content-Type', 'application/json').
            set('Authorization', tokenData), content = payment;
        return this._http.put(this.urlForUpdatePayment, content, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    PaymentService.prototype.deletePayment = function (paymentId) {
        var _this = this;
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Content-Type', 'application/json').
            set('Authorization', tokenData), params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().
            set('paymentId', paymentId.toString());
        return this._http.delete(this.urlForDeletePayment, { headers: headers, params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
...
var SchoolService = /** @class */ (function () {
    function SchoolService(_http, authService, snackBar) {
        this._http = _http;
        this.authService = authService;
        this.snackBar = snackBar;
    ...
    SchoolService.prototype.getSchools = function () {
        ...
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Content-Type', 'application/json').
            set('Authorization', tokenData);
        return this._http.get(this.urlForGetSchools, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    SchoolService.prototype.getSchoolLogoById = function (schoolId) {
        var _this = this;
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Authorization', tokenData), params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().
            set('schoolId', schoolId.toString());
        return this._http.get(this.urlForGetSchoolLogo, { headers: headers, params: params, responseType: 'blob' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    SchoolService.prototype.getSchoolById = function (schoolId) {
        var _this = this;
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Content-Type', 'application/json').
            set('Authorization', tokenData), params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().
            set('schoolId', schoolId.toString());
        return this._http.get(this.urlForGetSchool, { headers: headers, params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    SchoolService.prototype.createSchool = function (schoolName, logo) {
        var _this = this;
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Authorization', tokenData), content = logo, params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().
            set('schoolName', schoolName);
        return this._http.post(this.urlForCreateSchool, content, { headers: headers, params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    SchoolService.prototype.updateSchool = function (schoolName, schoolId, logo) {
        var _this = this;
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Authorization', tokenData), content = logo, params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().
            set('schoolId', schoolId.toString()).
            set('schoolName', schoolName);
        return this._http.put(this.urlForUpdateSchool, content, { headers: headers, params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    SchoolService.prototype.deleteSchool = function (schoolId) {
        var _this = this;
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Content-Type', 'application/json').
            set('Authorization', tokenData), params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().
            set('schoolId', schoolId.toString());
        return this._http.delete(this.urlForDeleteSchool, { headers: headers, params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
...
var SearchService = /** @class */ (function () {
    function SearchService(_http, authService, snackBar) {
        this._http = _http;
        this.authService = authService;
        this.snackBar = snackBar;
    ...
    SearchService.prototype.searchParent = function (searchLine) {
        var _this = this;
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Content-Type', 'application/json').
            set('Authorization', tokenData), params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().
            ...
            set('roleId', '4');
        return this._http.get(this.urlForSearchParents, { headers: headers, params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    SearchService.prototype.addParent = function (studentParent) {
        var _this = this;
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Content-Type', 'application/json').
            set('Authorization', tokenData), content = studentParent;
        return this._http.post(this.urlForAddParent, content, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
...
var SpinnerService = /** @class */ (function () {
    ...
    SpinnerService.prototype.ShowSpinner = function (spinnerName) {
        this.spinnerSet.forEach(function (spinner) {
            if (spinner.name === spinnerName) {
                spinner.isShown = true;
            }
        });
    };
    SpinnerService.prototype.HideSpinner = function (spinnerName) {
        this.spinnerSet.forEach(function (spinner) {
            if (spinner.name === spinnerName) {
...
var SportService = /** @class */ (function () {
    function SportService(_http, authService, snackBar) {
        this._http = _http;
        this.authService = authService;
        this.snackBar = snackBar;
    ...
    SportService.prototype.getSports = function () {
        ...
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Content-Type', 'application/json').
            set('Authorization', tokenData);
        return this._http.get(this.urlForGetSports, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
...
var StudentService = /** @class */ (function () {
    function StudentService(_http, authService, snackBar) {
        this._http = _http;
        this.authService = authService;
        this.snackBar = snackBar;
    ...
    StudentService.prototype.createStudent = function (student, groupId) {
        var _this = this;
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Content-Type', 'application/json').
            set('Authorization', tokenData), content = student, params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().
            set('groupId', groupId.toString());
        return this._http.post(this.urlForCreateStudent, content, { headers: headers, params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    StudentService.prototype.updateStudent = function (student, groupId) {
        var _this = this;
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Content-Type', 'application/json').
            set('Authorization', tokenData), content = student, params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().
            set('groupId', groupId.toString());
        return this._http.put(this.urlForUpdateStudent, content, { headers: headers, params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    StudentService.prototype.deleteStudent = function (studentId) {
        ...
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            ...
            set('Authorization', tokenData), params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().
            set('studentId', studentId.toString());
        return this._http.delete(this.urlForDeleteStudent, { headers: headers, params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
...
var UserService = /** @class */ (function () {
    function UserService(_http, authService, snackBar) {
        this._http = _http;
        this.authService = authService;
        this.snackBar = snackBar;
    ...
    UserService.prototype.getUsers = function () {
        ...
        var tokenData = 'Bearer ' + this.authService.getToken(), headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().
            set('Content-Type', 'application/json').
            set('Authorization', tokenData);
        return this._http.get(this.urlForGetUsers, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
    ...
    UserService.prototype.deleteUser = function (userId) {
        ...
        return this._http.delete(this.urlForDelete, { headers: headers, params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (res) {
            _this.snackBar.open("An Error Occured! Please, try again", "Got it", {
                duration: 2000
            });
            return _this.handleError(res);
...
var SidebarComponent = /** @class */ (function () {
    function SidebarComponent(dialog, authService, globalService, router) {
        this.dialog = dialog;
        this.authService = authService;
        this.globalService = globalService;
        this.router = router;
    ...
    SidebarComponent.prototype.openRegisterDialog = function () {
        var dialogRef = this.dialog.open(_register_user_register_user_component__WEBPACK_IMPORTED_MODULE_3__["RegisterUserComponent"], {
            width: '540px',
            height: '760px'
        });
...
var StudentComponent = /** @class */ (function () {
    function StudentComponent(studentService, authService, parentService, paymentService, spinnerService, snackBar, router, route, dialog) {
        this.studentService = studentService;
        this.authService = authService;
    ...
    StudentComponent.prototype.IsAdmin = function () {
        return this.authService.isAdmin();
    };
    StudentComponent.prototype.ModalParent = function () {
        var _this = this;
        var dialogRef = this.dialog.open(_search_dialog_search_dialog_component__WEBPACK_IMPORTED_MODULE_5__["SearchDialogComponent"], {
            width: '240px',
            height: 'auto',
            data: {
                StudentId: this.student.StudentId,
    ...
    StudentComponent.prototype.deleteParent = function (parentId, studentId) {
        var _this = this;
        this.parentService.deleteParent(parentId, studentId).subscribe(function (response) {
            _this.loadData();
        });
    };
    ;
    StudentComponent.prototype.deleteStudent = function () {
        var _this = this;
        this.studentService.deleteStudent(this.student.StudentId).subscribe(function (response) {
            _this.router.navigate(['/group/', _this.student.GroupId]);
        });
    };
    ;
    StudentComponent.prototype.editStudent = function () {
        var _this = this;
        var dialogRef = this.dialog.open(_edit_student_edit_student_component__WEBPACK_IMPORTED_MODULE_7__["EditStudentComponent"], {
            width: '540px',
            height: '450px',
            data: {
    ...
    StudentComponent.prototype.addPayment = function () {
        var _this = this;
        var dialogRef = this.dialog.open(_add_payment_add_payment_component__WEBPACK_IMPORTED_MODULE_9__["AddPaymentComponent"], {
            width: '540px',
            height: 'auto',
            data: {
                StudentId: this.student.StudentId
    ...
    StudentComponent.prototype.updatePayment = function (payment) {
        var _this = this;
        var dialogRef = this.dialog.open(_edit_payment_edit_payment_component__WEBPACK_IMPORTED_MODULE_11__["EditPaymentComponent"], {
            width: '540px',
            height: 'auto',
            data: {
                Payment: payment
    ...
    StudentComponent.prototype.deletePayment = function (paymentId) {
        var _this = this;
        this.spinnerService.ShowSpinner('LoadingProcess');
        this.paymentService.deletePayment(paymentId).subscribe(function (response) {
            var payments = _this.student.Payments;
            _this.student.Payments = payments.filter(function (item) { return item.PaymentId != paymentId; });
            _this.snackBar.open("Payment is deleted!", "Got it", {
                duration: 2000
            });
            _this.spinnerService.HideSpinner('LoadingProcess');
        });
    };
    StudentComponent.prototype.getTypeDescription = function (typeCode) {
        var typeModel = this.paymentTypes.find(function (item) { return item.TypeCode === typeCode; });
        return typeModel ? typeModel.TypeDescription : '';
    };
    StudentComponent.prototype.loadData = function () {
        var _this = this;
        this.spinnerService.ShowSpinner('LoadingProcess');
        var studentId = Number.parseInt(this.route.snapshot.paramMap.get('id'));
        this.studentService.getStudent(studentId).subscribe(function (response) {
...
var UsersComponent = /** @class */ (function () {
    function UsersComponent(userService, authService, spinnerService, dialog) {
    ...
    UsersComponent.prototype.deleteUser = function (userId) {
        var _this = this;
        this.userService.deleteUser(userId).subscribe(function (response) {
            _this.loadData();
        });
    };
